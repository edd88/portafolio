--------------------------------------------------------
-- Archivo creado  - lunes-octubre-07-2019   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "NOMAS"."IDCAPACITACION"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 2 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence IDCHECKLIST
--------------------------------------------------------

   CREATE SEQUENCE  "NOMAS"."IDCHECKLIST"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 2 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence IDCHECKLISTREPORTE
--------------------------------------------------------

   CREATE SEQUENCE  "NOMAS"."IDCHECKLISTREPORTE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 2 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "NOMAS"."IDCLIENTE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 3 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "NOMAS"."IDDETALLEBOLETA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 3 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence IDEVENTO
--------------------------------------------------------

   CREATE SEQUENCE  "NOMAS"."IDEVENTO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 3 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence IDMODIFICACIONCHECK
--------------------------------------------------------

   CREATE SEQUENCE  "NOMAS"."IDMODIFICACIONCHECK"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 3 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence IDPLANCONTRATADO
--------------------------------------------------------

   CREATE SEQUENCE  "NOMAS"."IDPLANCONTRATADO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 3 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence IDPROFESIONAL
--------------------------------------------------------

   CREATE SEQUENCE  "NOMAS"."IDPROFESIONAL"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 22 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "NOMAS"."IDUSUARIO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 24 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into NOMAS.TIPOUSUARIO (IDTIPOUSUARIO,DESCRIPCION) values (1,'profesional');
...
PROCEDURE LISTAR_CHECKLIST(c_checklist OUT T_CURSOR_CHECKLIST);
...
PROCEDURE LISTAR_REPORTE(c_reporte OUT T_CURSOR_REPORTE);
PROCEDURE BUSCAR_REPORTE(idReporte_c NUMBER,c_reporte OUT T_CURSOR_REPORTE);
END PKG_REPORTE;
...
PROCEDURE BUSCAR_USUARIO(user_c VARCHAR2,c_usuario OUT T_CURSOR_USUARIO);
END PKG_USUARIO;
...
IS
BEGIN
INSERT INTO CHECKLISTREPORTE VALUES (IDCHECKLISTREPORTE.NEXTVAL,estadoCheck_c,fecha_c,mejora_c,idCheckList_c);
COMMIT;
EXCEPTION
        WHEN OTHERS THEN
            ROLLBACK;
...
IS
BEGIN
INSERT INTO EVENTO VALUES (IDEVENTO.NEXTVAL,asesoria_c,fecha_c,idTipoEvento_c,idPlan_c);
COMMIT;
EXCEPTION
        WHEN OTHERS THEN
            ROLLBACK;
...
IS
BEGIN
INSERT INTO REPORTE VALUES (IDREPORTE.NEXTVAL,visitas_c,capacitacion_c,accidentes_c,multas_c,idUsuAdmin_c,idCliente_c);
COMMIT;
EXCEPTION
        WHEN OTHERS THEN
            ROLLBACK;
...
BEGIN
  OPEN c_reporte FOR
    SELECT * FROM REPORTE WHERE idReporte = idReporte_c;
END;
...
IS
BEGIN
INSERT INTO USUARIO VALUES (IDUSUARIO.NEXTVAL,user_c,pass_c,1,idTipoUsuario_c);
COMMIT;
EXCEPTION
        WHEN OTHERS THEN
            ROLLBACK;
...
BEGIN
  OPEN c_usuario FOR
    SELECT * FROM USUARIO WHERE usuario=user_c;
END;
...
--------------------------------------------------------
  ...
  ALTER TABLE "NOMAS"."CHECKLISTREPORTE" MODIFY ("FECHA" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "NOMAS"."EVENTO" MODIFY ("ASESORIA" NOT NULL ENABLE);
